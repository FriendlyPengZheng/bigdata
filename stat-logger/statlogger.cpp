...
void StatLogger::obtain_golds(string acct_id, int amt)
{
	...
	do_obtain_golds(acct_id, "_systemsend_", amt);
}
...
void StatLogger::buy_item(string acct_id,  bool isvip, int lv,  float pay_amount, string outcome, int outcnt)
{
	...
	do_buy_item(acct_id, isvip, lv,  pay_amount, "_coinsbuyitem_", outcome, outcnt);
    use_golds_buyitem(acct_id, isvip, pay_amount,lv);
}
