/**
 * @file i_monitor_thread.h
 * @brief 监控线程接口定义文件
 * @author richard <richard@taomee.com>
 * @date 2010-01-13
 */

#ifndef I_MONITOR_THREAD_H_20100113
#define I_MONITOR_THREAD_H_20100113
...
public:
	 ...
	 * @param p_route            路由信息
	 * @param p_ip               监控线程监听时所绑定的地址
	 * @param port               监控线程的监听端口
	 * @param username           监控线程认证用户名
	 * @param passwd             监控线程认证密码
	 * @return 成功返回0，失败返回－1
	 */
...
#endif //I_MONITOR_THREAD_H_20100113
