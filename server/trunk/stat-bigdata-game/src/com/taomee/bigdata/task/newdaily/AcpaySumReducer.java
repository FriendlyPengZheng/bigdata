...
public class AcpaySumReducer extends MapReduceBase implements Reducer<Text, Text, Text, DoubleWritable>
{
    ...
    public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, DoubleWritable> output, Reporter reporter) throws IOException
    {
        ...
        while(values.hasNext()) {
            ...
            double totalAmtAll = Double.valueOf(items[0]);
            int isNew = Integer.valueOf(items[1]);
            String distr = null;
            if(totalAmtAll <= 0.0) {
                if(isNew == 1) {
                    distr = "-2:付费为0的新增用户";
                ...
                distr = Distr.getDistrName(amtDistr, Distr.getRangeIndex(amtDistr, (int)totalAmtAll));
            }
