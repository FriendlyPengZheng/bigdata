...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-D mapred.reduce.tasks=2 \
        ...
        -input ${MONTH_DIR}/$year_month/account/part* \
        -output ${SUM_DIR}/$year_month/account-month/

#$DB_UPLOAD -type 2 -date ${year_month}01 -task 11 -path ${SUM_DIR}/$year_month/account-month/part*

${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
        com.taomee.bigdata.driver.MultipleInputsJobDriver \
        -conf ${HADOOP_CONF} \
	-D "ncount=3" \
        -jobName "Payer Month $date" \
		-gameInfo ${GAMEINFO} \
        -outKey org.apache.hadoop.io.Text \
        -outValue org.apache.hadoop.io.IntWritable \
        -inFormat org.apache.hadoop.mapred.TextInputFormat \
        -outFormat org.apache.hadoop.mapred.TextOutputFormat \
	-addInput ${MONTH_DIR}/$year_month/account/part*,com.taomee.bigdata.task.common.ANDMapper \
	-addInput ${ALL_DIR}/$date/pay-all/acpay*,com.taomee.bigdata.task.common.DIF2Mapper \
        -combinerClass  com.taomee.bigdata.task.common.SetCombiner \
        -reducerClass com.taomee.bigdata.task.common.SetReducer \
        -output ${MONTH_DIR}/$year_month/payer
