/**
 * =====================================================================================
 *       @file  statlog_control.cpp
 *      @brief  
 *
 *     Created  2015-10-27 17:00:19
 *    Revision  1.0.0.0
 *    Compiler  g++
...
// Public Methods
//--------------------------------------
StatLogControl::StatLogControl() : m_archiver(NULL),m_status_reporter(m_connector, CONFIG_SERVER, "."),m_reconnect_interval(30),m_heartbeat_interval(60)
{
}
