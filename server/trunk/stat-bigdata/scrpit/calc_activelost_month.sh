...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-conf ${HADOOP_CONF} \
	-D "nday=${n}" \
	-jobName "Active ${n} Month Lost $date" \
	-outKey org.apache.hadoop.io.Text \
	-outValue org.apache.hadoop.io.IntWritable \
	-inFormat org.apache.hadoop.mapred.TextInputFormat \
	-outFormat org.apache.hadoop.mapred.TextOutputFormat \
	-addInput ${MONTH_DIR}/$last_month/account/part-*,com.taomee.bigdata.task.nday.NDay0Mapper \
	...
	-output ${MONTH_DIR}/$this_month/active-lost-month
...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-D percent=percent \
	-conf ${HADOOP_CONF} \
	-jobName "Active ${n} Month Lost Sum $date" \
	-outKey org.apache.hadoop.io.Text \
	...
	-input ${MONTH_DIR}/$this_month/active-lost-month/part-* \
	-addMos "percent,org.apache.hadoop.mapred.TextOutputFormat,org.apache.hadoop.io.Text,org.apache.hadoop.io.Text" \
	-output ${SUM_DIR}/$this_month/active-lost-month

$DB_UPLOAD -type 2 -date ${this_month}01 -task 30 -path ${SUM_DIR}/$this_month/active-lost-month/part*
$DB_UPLOAD -type 2 -date ${this_month}01 -task 98 -path ${SUM_DIR}/$this_month/active-lost-month/percent* 
