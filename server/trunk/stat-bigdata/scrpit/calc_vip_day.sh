...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-D mapred.reduce.tasks=2 \
        -conf ${HADOOP_CONF} \
        -jobName "Vip Sum $date" \
        -outKey org.apache.hadoop.io.Text \
        -outValue org.apache.hadoop.io.IntWritable \
        -inFormat org.apache.hadoop.mapred.TextInputFormat \
        -outFormat org.apache.hadoop.mapred.TextOutputFormat \
        -addInput ${ALL_DIR}/$date/dayvip/part-*,com.taomee.bigdata.task.vip.Vip_day_sum_Mapper \
        -reducerClass com.taomee.bigdata.task.vip.Vip_day_sum_Reducer \
        -output ${SUM_DIR}/$date/day_sum_vip

$DB_UPLOAD -type 2 -date $date -task 144 -path ${SUM_DIR}/$date/day_sum_vip/part-*
