...
public class TongjiTadJoinReducer extends MapReduceBase implements Reducer<Text,Text,Text,NullWritable>{
	...
	private void initTad2GpzsMap(HashMap<String,Integer[]> map) {
		...
		map.put("5	-1	-1	-1	#7k7k.com", new Integer[]{10004,5,1,-1});
		map.put("5	-1	-1	-1	#4399.com", new Integer[]{10004,5,2,-1});
	}
