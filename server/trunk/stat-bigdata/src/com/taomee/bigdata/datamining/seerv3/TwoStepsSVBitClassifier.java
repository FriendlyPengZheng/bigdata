...
class TwoStepsSVBitClassifier extends Classifier {
    ...
    public static void main(String[] args) throws java.io.IOException {
        ...
        TwoStepsSVBitClassifier c = new TwoStepsSVBitClassifier();
        ...
        for(int i=0; i<numInstances; i++) {
            ...
            System.err.println(String.format("test1 %s => %s",
        ...
        for(int i=0; i<numInstances; i++) {
            ...
            System.err.println(String.format("run1 %s => %s",
                        classAtt.value((int)instance.classValue()), classAtt.value((int)v)));
        }
