...
public class MysqlConnection
{
    ...
    private String mysqlUrl = "jdbc:mysql://10.25.221.237/db_td_config?characterEncoding=utf8";
    private String mysqlUser = "tdconfig";
    private String mysqlPasswd = "tdconfig@mysql";
