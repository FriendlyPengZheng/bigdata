...
public class WriteIndexLabel {
	...
	String inputPath="hdfs://192.168.11.128:/ping/output/part-m-00000";
	String labPath="hdfs://192.168.11.128/ping/output/index.bin";
	Configuration conf=new Configuration();
	conf.set("mapred.job.tracker", "192.168.11.128");
