...
// Public Methods
//--------------------------------------
StatLogControl::StatLogControl() : m_archiver(NULL),m_updater(m_connector),m_status_reporter(m_connector, DB_SERVER, "."),m_update_interval(10*60),m_reconnect_interval(30),m_heartbeat_interval(60)
{
}
