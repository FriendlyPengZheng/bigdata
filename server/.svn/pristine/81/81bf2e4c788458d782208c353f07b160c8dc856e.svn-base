...
${HADOOP_PATH}hadoop fs -ls ${DAY_DIR}/$date/custom/DISTR${type_upper}*
if [[ $? -ne 0 ]]; then
	exit;
fi
...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-D "op_type=distr_$type" \
        ...
        -input ${DAY_DIR}/$date/custom/DISTR${type_upper}* \
        -output ${DAY_DIR}/$date/customdistr${type}

$DB_UPLOAD -type 2 -date $date -path ${DAY_DIR}/$date/customdistr${type}/part* 
