...
/**
 * 输入格式: 657 -1 -1 -1 android_web 0/1(flag) 
 * 输出格式: 657 -1 -1 -1 android_web 留存率
 * 
 * @author looper
 * @date 2017年4月12日
 */
public class RegAdSecondReducer extends MapReduceBase implements
	...
	public void reduce(Text key, Iterator<DoubleWritable> values,
		...
		if (yearsTodayNewRegCount == 0.0) {
			...
			outputValue.set(Double.parseDouble(df.format(yearsTodayNewRegTodayLoginCount
					/ yearsTodayNewRegCount)));
