 ...
 * @date 2013-11-11
 */
public class TranProtocol0x1002_0x1003 extends TranProtocol {
	...
	public byte[] pack(){
        ...
        try {
            ...
            byteBuffer.put(toLH(time+hour*3600));
            ...
            //System.out.println(String.format("time=%d value=%f gpzs=%d %d %d %d stid=%s %d sstid=%s %d op_field=%s %d key=%s %d",
            //            time+hour*3600, value, game_id, platform_id, zone_id, server_id, stid, stid_len, sstid, sstid_len, op_field, field_len, key, key_len));
