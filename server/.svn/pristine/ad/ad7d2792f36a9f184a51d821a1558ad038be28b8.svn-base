...
#task_id=39,40,42,102,104
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	com.taomee.bigdata.driver.MultipleInputsJobDriver \
	-conf ${HADOOP_CONF} \
	-jobName "New Online Week $date" \
	-gameInfo ${GAMEINFO} \
	...
	$inputs \
	-addInput ${WEEK_DIR}/$first_week_day/account-new/part*,com.taomee.bigdata.task.online.GrepUserMapper \
	-reducerClass com.taomee.bigdata.task.online.UserOnlineReducer \
	-output ${WEEK_DIR}/$first_week_day/new-online
...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-conf ${HADOOP_CONF} \
        -jobName "New Online Week Sum $date" \
		-gameInfo ${GAMEINFO} \
        -outKey org.apache.hadoop.io.Text \
        -outValue org.apache.hadoop.io.Text \
        -inFormat org.apache.hadoop.mapred.TextInputFormat \
	...
	-input ${WEEK_DIR}/$first_week_day/new-online/part* \
	...
	-output ${SUM_DIR}/$first_week_day/new-online-week

#$DB_UPLOAD -type 2 -date $first_week_day -task 39  -path ${SUM_DIR}/$first_week_day/new-online-week/countdaydistr*
#$DB_UPLOAD -type 2 -date $first_week_day -task 40  -path ${SUM_DIR}/$first_week_day/new-online-week/countdistr*
#$DB_UPLOAD -type 2 -date $first_week_day -task 42  -path ${SUM_DIR}/$first_week_day/new-online-week/lengthdistr*
#$DB_UPLOAD -type 2 -date $first_week_day -task 102 -path ${SUM_DIR}/$first_week_day/new-online-week/lengthall*
#$DB_UPLOAD -type 2 -date $first_week_day -task 104 -path ${SUM_DIR}/$first_week_day/new-online-week/countall*
