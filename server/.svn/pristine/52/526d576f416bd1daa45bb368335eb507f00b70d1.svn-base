...
do
	...
	-D "stid=_lgac_" \
	-D "nday=${n}" \
	-jobName "Payer ${n} day Lost $date" \
	-gameInfo ${GAMEINFO} \
	-outKey org.apache.hadoop.io.Text \
	-outValue org.apache.hadoop.io.IntWritable \
	-inFormat org.apache.hadoop.mapred.TextInputFormat \
	-outFormat org.apache.hadoop.mapred.TextOutputFormat \
	-addInput ${DAY_DIR}/$nday/payer/part*,com.taomee.bigdata.task.nday.NDay0Mapper \
	$inputs \
	-reducerClass com.taomee.bigdata.task.lost.LostReducer \
	-output ${DAY_DIR}/$date/payer-lost-${n}
	...
	-D percent=percent \
	-conf ${HADOOP_CONF} \
	-jobName "Payer ${n} day Lost Sum $date" \
	-gameInfo ${GAMEINFO} \
	-outKey org.apache.hadoop.io.Text \
	...
	-input ${DAY_DIR}/$date/payer-lost-${n}/part* \
	-addMos "percent,org.apache.hadoop.mapred.TextOutputFormat,org.apache.hadoop.io.Text,org.apache.hadoop.io.Text" \
	-output ${SUM_DIR}/$date/payer-lost-${n}

	#$DB_UPLOAD -type 2 -date $date -task 31 -path ${SUM_DIR}/$date/payer-lost-${n}/part*
	#$DB_UPLOAD -type 2 -date $date -task 99 -path ${SUM_DIR}/$date/payer-lost-${n}/percent*
done
