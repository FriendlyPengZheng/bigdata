...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-D "stid=_lgpl_" \
	-D "ncount=0" \
        -jobName "Player Version Week $date" \
	...
	-output ${WEEK_VERSION_DIR}/$first_version_week_day/player

${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
        com.taomee.bigdata.driver.SimpleJobDriver \
	-D mapred.reduce.tasks=2 \
        -conf ${HADOOP_CONF} \
        -jobName "Player Version Week Sum $date" \
        -outKey org.apache.hadoop.io.Text \
        -outValue org.apache.hadoop.io.IntWritable \
        -inFormat org.apache.hadoop.mapred.TextInputFormat \
        -outFormat org.apache.hadoop.mapred.TextOutputFormat \
	...
	-input ${WEEK_VERSION_DIR}/$first_version_week_day/player/part-* \
	-output ${SUM_DIR}/$first_version_week_day/player-version-week/

$DB_UPLOAD -type 2 -date $first_version_week_day -task 365 -path ${SUM_DIR}/$first_version_week_day/player-version-week/part*
