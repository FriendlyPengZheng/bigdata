...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-addInput ${ALL_DIR}/${year_month}*/account-all/firstLog-*,com.taomee.bigdata.task.common.ORMapper \
        -combinerClass  com.taomee.bigdata.task.common.SetCombiner \
        -reducerClass com.taomee.bigdata.task.common.SetReducer \
        -output ${MONTH_DIR}/$year_month/account-new
...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-D mapred.reduce.tasks=2 \
        ...
        -input ${MONTH_DIR}/$year_month/account-new/part-* \
        -output ${SUM_DIR}/$year_month/account-new-month/

$DB_UPLOAD -type 2 -date ${year_month}01 -task 115 -path ${SUM_DIR}/$year_month/account-new-month/part* 
