...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	$inputs \
        ...
        -output ${WEEK_DIR}/$first_week_day/player-new

${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
        com.taomee.bigdata.driver.SimpleJobDriver \
	-D mapred.reduce.tasks=2 \
        -conf ${HADOOP_CONF} \
        -jobName "Player New Week Sum $date" \
		-gameInfo ${GAMEINFO} \
        -outKey org.apache.hadoop.io.Text \
        -outValue org.apache.hadoop.io.IntWritable \
        -inFormat org.apache.hadoop.mapred.TextInputFormat \
        ...
        -input ${WEEK_DIR}/$first_week_day/player-new/part* \
        -output ${SUM_DIR}/$first_week_day/player-new-week/

#$DB_UPLOAD -type 2 -date $first_week_day -task 8 -path ${SUM_DIR}/$first_week_day/player-new-week/part*
