...
(function(window, undefined) {
    ...
    function _gTreeJsonData() {
        return {
            ...
            ajax: {
                url: getUrl("gamecustom", "tree", "getManageTree"),
                data: function(n) {
                    return {
                        game_id: $("#J_paramGameId").val(),
    ...
    function _showContent(isLeaf, nodeId) {
        ...
        if (isLeaf === "1") {//show report list
            ...
            ajaxData(getUrl("gamecustom", "manage", "getStatItemByNodeId"), {
                node_id : nodeId
            }, function(data){
            ...
            ajaxData(getUrl("gamecustom", "tree", "getManageTree"), {
    ...
    function _headTools() {
        ...
        mergeBtn.click(function(e){
            ...
            if(parseInt((_getCurNode()).attr("is_leaf"), 10) == 0) {
                ajaxData(getUrl("gamecustom", "tree", "mergeNode") ,{ id : curNode.attr("node_id") }, function() {
        ...
        deleteBatchBtn.click(function() {
            ...
            if (curNode.attr("node_id") == -1) {// delete report
                ...
                param.parent_id = -1;
                ajaxData(getUrl("gamecustom", "tree", "moveStatItem"), param, function(data) {
                    $("#J_tree").jstree("refresh", -1);
                }, true);
            } else { // delete node
                ajaxData(getUrl("gamecustom", "tree", "delNode"), param, function(data) {
                    $("#J_tree").jstree("refresh", -1);
                }, true);
            }
            return false;
    ...
    function _addNode() {
        ...
        var _fn = function(t) {
            ...
            if(t.val()) {
                ...
                ajaxData(getUrl("gamecustom", "tree", "addNode"), {
                    name: t.val(),
    ...
    function _initStatList(lists) {
        $.each([lang.t("常规统计项"), lang.t("自定义加工项")], function(typeIdx, typeTitle) {
            lists[typeIdx] = {
                title: typeTitle,
                lists: []
            };
    ...
    function _checkChildrenIsLeaf(id) {
        var check = true;
        ajax(getUrl("gamecustom", "tree", "getManageTree"),
    ...
    function move(param, type) {
        ...
        switch (type) {
            case 2:
                url = getUrl("gamecustom", "tree", "moveStatItem");
                break;
            ...
            default:
                url = getUrl("gamecustom", "tree", "moveNode");
                break;
        }
    ...
    function _delete(obj) {
        ...
        if (type != "node") {
            ...
            url = getUrl("gamecustom", "tree", "delNode");
            param.id = id;
        }
    ...
    function _rename(obj) {
        var titleSpan = obj.find(".list-title span"),
            ...
            type = obj.attr("data-type"),
            id = obj.attr("data-id"),
            url = getUrl("gamecustom", "tree", "setName");
        url = type == "node" ? url : getUrl("gamecustom", "manage", "setStatItemName");
        var _fn = function(t) {
            var newName = t.val(),
