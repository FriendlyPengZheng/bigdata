...
do
	...
	if [[ $? -eq 0 ]]; then
		inputs="$inputs -addInput ${DAY_DIR}/$last_day/basic/startdev*,com.taomee.bigdata.task.common.SourceORMapper "
	fi
done
if [[ $inputs == "" ]]; then
        echo "empty inputs"
...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
	...
	-output ${WEEK_DIR}/$first_week_day/device

${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
        com.taomee.bigdata.driver.SimpleJobDriver \
	-D mapred.reduce.tasks=2 \
        -conf ${HADOOP_CONF} \
        -jobName "Device Week Sum $date" \
		-gameInfo ${GAMEINFO} \
        -outKey org.apache.hadoop.io.Text \
        -outValue org.apache.hadoop.io.IntWritable \
        -inFormat org.apache.hadoop.mapred.TextInputFormat \
	...
	-input ${WEEK_DIR}/$first_week_day/device/part* \
        -output ${SUM_DIR}/$first_week_day/device-week/

#$DB_UPLOAD -type 2 -date $first_week_day -task 17 -path ${SUM_DIR}/$first_week_day/device-week/part*
