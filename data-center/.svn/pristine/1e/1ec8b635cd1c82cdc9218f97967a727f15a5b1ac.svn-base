...
//	}
	...
	public static boolean key_no_invalid_chars(String key){
	...
	public static boolean string_no_invalid_chars(String str,String invalidChars){
		if(str == null){
			return false;
		}
		if(str.length() == 0 || invalidChars == null || invalidChars.length() == 0){
			return true;
		}
		for(int i=0;i<=str.length()-1;i++){
			for(int j = 0;j<=invalidChars.length()-1;j++){
	...
	public static boolean string_firstend_no_invalid_chars(String str,String invalidChars){
		...
		for(int i = 0;i<=invalidChars.length()-1;i++){
			if(str.charAt(0) == invalidChars.charAt(i))return false;
			if(str.charAt(str.length()-1) == invalidChars.charAt(i))return false;
		}
		return true;
	}
