...
${HADOOP_PATH}hadoop fs -ls ${DAY_DIR}/$date/basic/UCOUNT-*
if [[ $? -ne 0 ]]; then
	exit;
fi
...
${HADOOP_PATH}hadoop jar ${HADOOP_JAR_PATH} \
        ...
        -input ${DAY_DIR}/$date/basic/UCOUNT-* \
        -output ${DAY_DIR}/$date/ucount

#$DB_UPLOAD -type 2 -date $date -path ${DAY_DIR}/$date/ucount/part*
