...
public class RechargeVipMonthMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>
{
    ...
    //output key=game,zone,server,platform,uid  value=1, value,payamt
    public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException
    {
        ...
        if(logAnalyser.analysis(value.toString()) == ReturnCode.G_OK &&
            ...
            if(game != null &&
                ...
                outputValue.set(String.format("%s\t%s\t%s", 1, value_day, amt));
