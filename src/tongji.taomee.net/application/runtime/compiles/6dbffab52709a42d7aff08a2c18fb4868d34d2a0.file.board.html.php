<?php /*%%TemplateHeaderCode:18815674105c9cb15ab3e993-03275585%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '6dbffab52709a42d7aff08a2c18fb4868d34d2a0' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/gameanalysis/board.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '18815674105c9cb15ab3e993-03275585',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5c9cb15ad24531_41932911',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c9cb15ad24531_41932911')) { function content_5c9cb15ad24531_41932911($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
<link rel="stylesheet" type="text/css" href="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/css/page/gameanalysis/board.css?ver=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
">
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '18815674105c9cb15ab3e993-03275585');
content_5c9cb15abf4336_42268203($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '18815674105c9cb15ab3e993-03275585');
content_5c9cb15ac47aa6_95009754($_tpl);
$_tpl = array_pop($_tplStack);
...
"><?php echo $_tpl->tplVars['platform']->value['gpzs_name']; ?>
            ...
            <div class="datepicker-trigger radius5-all single fr mr5" id="J_toTime">
                <input type="hidden" id="J_to" value="<?php echo $_tpl->tplVars['response']->value['param']['to']; ?>
" />
                <i class="datepicker-icon"></i>
                <input class="title" type="text" id="J_date" value="<?php echo $_tpl->tplVars['response']->value['param']['to']; ?>
" />
        ...
        <div class="content-body" id="J_contentBody">
            <div class="content-item">
                <h2 class="title new-player"><?php echo TM::t('tongji','新玩家'); ?>
</h2>
                <div class="container clearfix" id="J_contentNewPlayer"></div>
            </div>
            <div class="content-item">
                <h2 class="title active-player"><?php echo TM::t('tongji','活跃玩家'); ?>
</h2>
                <div class="container clearfix" id="J_contentActivePlayer"></div>
            </div>
            <div class="content-item">
                <h2 class="title revenue"><?php echo TM::t('tongji','收入'); ?>
</h2>
                <div class="container clearfix" id="J_contentRevenue"></div>
            </div>
            <div class="content-item">
                <h2 class="title first-pay"><?php echo TM::t('tongji','首次付费'); ?>
</h2>
...
"></script>
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/gameanalysis/board.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c9cb15abe47e8_17099140')) { function content_5c9cb15abe47e8_17099140($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c9cb15abf4336_42268203')) { function content_5c9cb15abf4336_42268203($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c9cb15ac47aa6_95009754')) { function content_5c9cb15ac47aa6_95009754($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
