<?php /*%%TemplateHeaderCode:4253517515cb4469f9bee72-73069163%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '5991d67ea6d7fae5563e869d14bb60466405dd4f' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/gameanalysis/month_gp.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '4253517515cb4469f9bee72-73069163',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5cb4469fb98773_00258034',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cb4469fb98773_00258034')) { function content_5cb4469fb98773_00258034($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '4253517515cb4469f9bee72-73069163');
content_5cb4469fa6d748_81178898($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '4253517515cb4469f9bee72-73069163');
content_5cb4469fac09c4_88124448($_tpl);
$_tpl = array_pop($_tplStack);
...
"><?php echo $_tpl->tplVars['platform']->value['gpzs_name']; ?>
            ...
            <div class="datepicker-trigger radius5-all r mr5 single" id="J_from_to" >
                <input type="hidden" id="J_from" value="<?php echo $_tpl->tplVars['response']->value['param']['from']; ?>
" />
                <i class="datepicker-icon"></i>
                <input class="title" type="text" id="J_date" value="<?php echo date('Y-m',strtotime($_tpl->tplVars['response']->value['param']['from'])); ?>
" />
...
"></script>
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/gameanalysis/month_gp.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb4469fa5d657_19813228')) { function content_5cb4469fa5d657_19813228($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb4469fa6d748_81178898')) { function content_5cb4469fa6d748_81178898($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb4469fac09c4_88124448')) { function content_5cb4469fac09c4_88124448($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
