<?php /*%%TemplateHeaderCode:7405106655a95236cacf043-65870773%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '84b70fd6031c15fb1b9b8bc270bce312528a806c' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/gameanalysis/board.html',
      1 => 1484553623,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '7405106655a95236cacf043-65870773',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5a95236d086fb7_06998292',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a95236d086fb7_06998292')) { function content_5a95236d086fb7_06998292($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '7405106655a95236cacf043-65870773');
content_5a95236cca0897_48897381($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '7405106655a95236cacf043-65870773');
content_5a95236cd7d289_83670998($_tpl);
$_tpl = array_pop($_tplStack);
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a95236cc78737_61153051')) { function content_5a95236cc78737_61153051($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a95236cca0897_48897381')) { function content_5a95236cca0897_48897381($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a95236cd7d289_83670998')) { function content_5a95236cd7d289_83670998($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
