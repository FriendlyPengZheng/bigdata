<?php /*%%TemplateHeaderCode:12721330565cc56d73792503-76686463%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    'c5d562cebf002c75a79c3cfd201c00b3ad3ffe1c' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/conf/pages.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '12721330565cc56d73792503-76686463',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5cc56d738f8ad5_35808771',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cc56d738f8ad5_35808771')) { function content_5cc56d738f8ad5_35808771($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav-blank.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '12721330565cc56d73792503-76686463');
content_5cc56d73830be0_12158904($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '12721330565cc56d73792503-76686463');
content_5cc56d7384cec2_43359582($_tpl);
$_tpl = array_pop($_tplStack);
/* End of included template "layout/aside.html" */?>
    <div class="content" >
        <table class="table module-table">
            ...
            <tbody>
                <?php $_tpl->tplVars['page'] = new TMTemplateVariable; $_tpl->tplVars['page']->_loop = false;
$_tpl->tplVars['url'] = new TMTemplateVariable;
$_from = $_tpl->tplVars['response']->value['pages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }
foreach ($_from as $_tpl->tplVars['page']->key => $_tpl->tplVars['page']->value) {
$_tpl->tplVars['page']->_loop = true;
$_tpl->tplVars['url']->value = $_tpl->tplVars['page']->key;
?>
                <tr>
                    <?php $_tpl->tplVars['i'] = new TMTemplateVariable; $_tpl->tplVars['i']->value = 0;
 if ($_tpl->tplVars['i']->value<4) { for ($foo=true; $_tpl->tplVars['i']->value<4; $_tpl->tplVars['i']->value++) {
?>
                        <?php if ($_tpl->tplVars['i']->value==3||$_tpl->tplVars['i']->value==2) {?>
                        <td class="td hd"><a href="<?php echo $_tpl->tplVars['response']->value['param']['script_name']; ?>
?r=admin/manage/displayPage&navi_key=<?php echo $_tpl->tplVars['page']->value['key']; ?>
&module_name=<?php echo $_tpl->tplVars['page']->value['title']; ?>
&page_url=<?php echo $_tpl->tplVars['page']->value['url']; ?>
" class="item" title="修改页面"> <?php if (isset($_tpl->tplVars['page']->value['name'][$_tpl->tplVars['i']->value])) {?><?php echo $_tpl->tplVars['page']->value['name'][$_tpl->tplVars['i']->value]; ?>
 <?php } else { ?> - <?php }?> </a></td>
                        <?php } else { ?>
                        <td class="td hd"> <?php if (isset($_tpl->tplVars['page']->value['name'][$_tpl->tplVars['i']->value])) {?><?php echo $_tpl->tplVars['page']->value['name'][$_tpl->tplVars['i']->value]; ?>
 <?php } else { ?> - <?php }?> </td>
                        <?php }?>
                    <?php }} ?>
                    <td class="td hd"><?php echo $_tpl->tplVars['page']->value['key']; ?>
</a></td>
                    <td class="td hd">
                        <a href="<?php echo $_tpl->tplVars['response']->value['param']['script_name']; ?>
?r=<?php echo $_tpl->tplVars['url']->value; ?>
&navi_key=<?php echo $_tpl->tplVars['page']->value['key']; ?>
" class="item mr20" title="查看页面">查看</a>
						<a href="<?php echo $_tpl->tplVars['response']->value['param']['script_name']; ?>
?r=admin/manage/displayPage&navi_key=<?php echo $_tpl->tplVars['page']->value['key']; ?>
&module_name=<?php echo $_tpl->tplVars['page']->value['title']; ?>
&page_url=<?php echo $_tpl->tplVars['page']->value['url']; ?>
" class="item mr20" title="修改页面">修改</a>
						<a href="#" data-key="<?php echo $_tpl->tplVars['page']->value['key']; ?>
" class="item J-btn-build" title="生成JSON">生成JSON</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
...
<script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/conf/pages.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cc56d73830be0_12158904')) { function content_5cc56d73830be0_12158904($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cc56d7384cec2_43359582')) { function content_5cc56d7384cec2_43359582($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
