<?php /*%%TemplateHeaderCode:2578425255cc56d82d019d3-13749452%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    'feabfc3aad71602e8d4b89308dd34a5c561af466' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/conf/module.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '2578425255cc56d82d019d3-13749452',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5cc56d82e05f02_19490907',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cc56d82e05f02_19490907')) { function content_5cc56d82e05f02_19490907($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
" class="bar-view"><i class="iconfont icon-back"></i>查看模板页面</a>
        <a href="<?php echo $_tpl->tplVars['response']->value['param']['script_name']; ?>
?r=admin/manage/index/01" class="bar-view"><i class="iconfont icon-back"></i>返回导航列表</a>
        </li>
    </ul>
</div>
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cc56d82da2f61_30405253')) { function content_5cc56d82da2f61_30405253($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
    <ul class="main-sub-nav">
