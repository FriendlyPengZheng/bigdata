<?php /*%%TemplateHeaderCode:10142926365cb5892db3ad70-93229718%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    'd43f2e79f3fcf50d68639ff8fb42cca3ef4d65a1' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/gameanalysis/realtime.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '10142926365cb5892db3ad70-93229718',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5cb5892dd0d743_99541939',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cb5892dd0d743_99541939')) { function content_5cb5892dd0d743_99541939($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '10142926365cb5892db3ad70-93229718');
content_5cb5892dbe9639_62678394($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '10142926365cb5892db3ad70-93229718');
content_5cb5892dc3b1b6_14089452($_tpl);
$_tpl = array_pop($_tplStack);
...
"><?php echo $_tpl->tplVars['platform']->value['gpzs_name']; ?>
            ...
            <label class="fr cstcon">
                <input type="checkbox" class="cstchk" id="J_fakeContrast"/>
...
"></script>
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/gameanalysis/realtime.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb5892dbd9e20_53209590')) { function content_5cb5892dbd9e20_53209590($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb5892dbe9639_62678394')) { function content_5cb5892dbe9639_62678394($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb5892dc3b1b6_14089452')) { function content_5cb5892dc3b1b6_14089452($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
