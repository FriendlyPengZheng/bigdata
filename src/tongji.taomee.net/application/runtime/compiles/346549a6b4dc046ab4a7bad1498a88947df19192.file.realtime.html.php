<?php /*%%TemplateHeaderCode:10379916865b7e1c8910fab1-15937064%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '346549a6b4dc046ab4a7bad1498a88947df19192' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/topic/realtime.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '10379916865b7e1c8910fab1-15937064',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5b7e1c8927a033_27061923',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b7e1c8927a033_27061923')) { function content_5b7e1c8927a033_27061923($_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <meta name="robots" content="nofollow,noindex">
        <title><?php echo $_tpl->tplVars['response']->value['application_info']['name']; ?>
-<?php echo TM::t('tongji','专题分析'); ?>
</title>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("topic/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '10379916865b7e1c8910fab1-15937064');
content_5b7e1c891c22e1_05042987($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '10379916865b7e1c8910fab1-15937064');
content_5b7e1c891de2f5_15172564($_tpl);
$_tpl = array_pop($_tplStack);
...
" />
        <div class="content-header clearfix" id="J_contentHeader">
            ...
            <label class="fr cstcon">
                ...
                <span class=""><?php echo TM::t('tongji','一周对比'); ?>
</span>
            </label>
            <div class="datepicker-trigger radius5-all single fr mr5" id="J_fromTime">
                <input type="hidden" id="J_from" value="<?php echo $_tpl->tplVars['response']->value['param']['to']; ?>
" />
...
"></script>
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/topic/realtime.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5b7e1c891b2c61_90928297')) { function content_5b7e1c891b2c61_90928297($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5b7e1c891c22e1_05042987')) { function content_5b7e1c891c22e1_05042987($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <?php if (isset($_tpl->tplVars['response']->value['admin_auth'])) {?>
        <li class="sub-nav-li posr stat-button" title="模板管理">
        <a href="index.php?r=admin/manage/displayPage&page_url=<?php echo $_tpl->tplVars['response']->value['param']['r']; ?>
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5b7e1c891de2f5_15172564')) { function content_5b7e1c891de2f5_15172564($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
