<?php /*%%TemplateHeaderCode:795484205a9523766d3f69-11334231%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    'a4ff14ea912c41c27b9f8cd3f3aa2b81daa84343' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/gamecustom/view.html',
      1 => 1484553623,
      2 => 'file',
    ),
    ...
    'c8b59838f561b724507cdd92548f58bc5d7bd83c' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/gamecustom/sub-nav-view.html',
      1 => 1506508413,
      2 => 'file',
    ),
  ),
  'no_cache_hash' => '795484205a9523766d3f69-11334231',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5a952376af48a4_05396096',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a952376af48a4_05396096')) { function content_5a952376af48a4_05396096($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gamecustom/sub-nav-view.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '795484205a9523766d3f69-11334231');
content_5a9523768aec16_00031254($_tpl);
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952376886fc2_98139948')) { function content_5a952376886fc2_98139948($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a9523768aec16_00031254')) { function content_5a9523768aec16_00031254($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
