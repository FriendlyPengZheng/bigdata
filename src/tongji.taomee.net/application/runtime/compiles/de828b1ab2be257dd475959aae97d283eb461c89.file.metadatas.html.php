<?php /*%%TemplateHeaderCode:20716332425c99c27239ec76-88317195%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    'de828b1ab2be257dd475959aae97d283eb461c89' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/conf/metadatas.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '20716332425c99c27239ec76-88317195',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5c99c2724fd425_31273400',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c99c2724fd425_31273400')) { function content_5c99c2724fd425_31273400($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav-blank.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '20716332425c99c27239ec76-88317195');
content_5c99c27243c7d5_13590601($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '20716332425c99c27239ec76-88317195');
content_5c99c272458b03_59943321($_tpl);
$_tpl = array_pop($_tplStack);
/* End of included template "layout/aside.html" */?>
    <div class="content" id="J_tableContainer">
        ...
        <table class="table module-table">
            ...
            <tbody>
                <?php $_tpl->tplVars['metadata'] = new TMTemplateVariable; $_tpl->tplVars['metadata']->_loop = false;
$_from = $_tpl->tplVars['response']->value['metadatas']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }
foreach ($_from as $_tpl->tplVars['metadata']->key => $_tpl->tplVars['metadata']->value) {
$_tpl->tplVars['metadata']->_loop = true;
?>
                <tr>
                    <td class="td hd"><?php echo $_tpl->tplVars['metadata']->value['period_name']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['metadata']->value['data_name']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['metadata']->value['type_name']; ?>
</td>
                    <?php if ($_tpl->tplVars['metadata']->value['type']=='1') {?>
                    <td class="td hd">stid=<?php echo $_tpl->tplVars['metadata']->value['stid']; ?>
&#38;sstid=<?php echo $_tpl->tplVars['metadata']->value['sstid']; ?>
&#38;op_type=<?php echo $_tpl->tplVars['metadata']->value['op_type']; ?>
&#38;op_fields=<?php echo $_tpl->tplVars['metadata']->value['op_fields']; ?>
&#38;range=<?php echo $_tpl->tplVars['metadata']->value['range']; ?>
</td>
                    <?php } else { ?>
                    <td class="td hd">task_id=<?php echo $_tpl->tplVars['metadata']->value['task_id']; ?>
&#38;range=<?php echo $_tpl->tplVars['metadata']->value['range']; ?>
</td>
                    <?php }?>
                    <td class="td hd"><?php echo $_tpl->tplVars['metadata']->value['factor']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['metadata']->value['precision']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['metadata']->value['unit']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['metadata']->value['comment']; ?>
</td>
                    <td class="td hd">
                        <a href="javascript: void(0);" class="upd-btn btn-green" data='<?php echo json_encode($_tpl->tplVars['metadata']->value); ?>
' title="修改元数据配置">修改</a>
                        <a href="javascript: void(0);" class="del-btn btn-green" data='<?php echo json_encode($_tpl->tplVars['metadata']->value); ?>
' title="删除元数据配置">删除</a>
                    </td>
                </tr>
                <?php } ?>
...
<script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/conf/metadatas.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c99c27243c7d5_13590601')) { function content_5c99c27243c7d5_13590601($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c99c272458b03_59943321')) { function content_5c99c272458b03_59943321($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
