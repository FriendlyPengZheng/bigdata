<?php /*%%TemplateHeaderCode:7499032035a952377b27be9-30312135%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '4d36cfcd0005ddb5d0cc439ff26018941c11d6ce' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/topic/single.html',
      1 => 1484553623,
      2 => 'file',
    ),
    ...
    'ab627624d488c262c3ef703cd0f45e053a365391' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/topic/sub-nav.html',
      1 => 1506508412,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '7499032035a952377b27be9-30312135',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5a952377f17070_02624948',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a952377f17070_02624948')) { function content_5a952377f17070_02624948($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("topic/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '7499032035a952377b27be9-30312135');
content_5a952377d00144_18948486($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '7499032035a952377b27be9-30312135');
content_5a952377d679c0_04328704($_tpl);
$_tpl = array_pop($_tplStack);
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952377cd8924_66347968')) { function content_5a952377cd8924_66347968($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952377d00144_18948486')) { function content_5a952377d00144_18948486($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <?php if (isset($_tpl->tplVars['response']->value['admin_auth'])) {?>
        <li class="sub-nav-li posr stat-button" title="模板管理">
        <a href="index.php?r=admin/manage/displayPage&page_url=<?php echo $_tpl->tplVars['response']->value['param']['r']; ?>
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952377d679c0_04328704')) { function content_5a952377d679c0_04328704($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
