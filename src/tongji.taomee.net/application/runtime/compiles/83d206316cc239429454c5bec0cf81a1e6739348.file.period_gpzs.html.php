<?php /*%%TemplateHeaderCode:1618426435a952381a92468-95847115%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '83d206316cc239429454c5bec0cf81a1e6739348' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/gameanalysis/period_gpzs.html',
      1 => 1484553623,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '1618426435a952381a92468-95847115',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5a95238205fdc7_48321654',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a95238205fdc7_48321654')) { function content_5a95238205fdc7_48321654($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '1618426435a952381a92468-95847115');
content_5a952381c59282_57039216($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '1618426435a952381a92468-95847115');
content_5a952381d34b23_78843720($_tpl);
$_tpl = array_pop($_tplStack);
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952381c31750_59991506')) { function content_5a952381c31750_59991506($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952381c59282_57039216')) { function content_5a952381c59282_57039216($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952381d34b23_78843720')) { function content_5a952381d34b23_78843720($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
