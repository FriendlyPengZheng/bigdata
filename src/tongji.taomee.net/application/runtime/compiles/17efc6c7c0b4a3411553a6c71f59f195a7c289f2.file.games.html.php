<?php /*%%TemplateHeaderCode:9131234005cc56d6ec321d4-04126180%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '17efc6c7c0b4a3411553a6c71f59f195a7c289f2' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/conf/games.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '9131234005cc56d6ec321d4-04126180',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5cc56d6ed8c314_86358878',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cc56d6ed8c314_86358878')) { function content_5cc56d6ed8c314_86358878($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav-blank.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '9131234005cc56d6ec321d4-04126180');
content_5cc56d6ecd2ab5_58460671($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '9131234005cc56d6ec321d4-04126180');
content_5cc56d6ecef0e0_60774061($_tpl);
$_tpl = array_pop($_tplStack);
        ...
        <table class="table module-table">
            <thead>
                <tr>
                    ...
                    <th class="th">游戏名称</th>
                    <th class="th">类型</th>
                    <th class="th" data-type="number">查看权限ID</th>
                    <th class="th" data-type="number">管理权限ID</th>
                    <th class="th" data-type="number">online查看权限ID</th>
                    <th class="th" data-type="string">功能标志</th>
                    <th class="th" data-type="string">忽略项</th>
                    <th class="th">状态</th>
...
$_from = $_tpl->tplVars['response']->value['games']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }
foreach ($_from as $_tpl->tplVars['game']->key => $_tpl->tplVars['game']->value) {
$_tpl->tplVars['game']->_loop = true;
?>
                <tr>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['game_id']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['game_name']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['game_type']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['auth_id']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['manage_auth_id']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['online_auth_id']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['func_slot']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['ignore']; ?>
</td>
                    <td class="td hd"><?php echo $_tpl->tplVars['game']->value['status_name']; ?>
</td>
                    <td class="td hd">
                        <?php if ($_tpl->tplVars['game']->value['status']==1) {?>
                        <a href="#" class="del-btn btn-green" data='<?php echo json_encode($_tpl->tplVars['game']->value); ?>
' title="废弃">废弃</a>
                        <?php } else { ?>
                        <a href="#" class="del-btn btn-green" data='<?php echo json_encode($_tpl->tplVars['game']->value); ?>
' title="开始使用">开始使用</a>
                        <?php }?>
                        <a href="#" class="upd-btn btn-green" data='<?php echo json_encode($_tpl->tplVars['game']->value); ?>
' title="修改游戏配置">修改</a>
                    </td>
                </tr>
                <?php } ?>
...
<script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/conf/games.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cc56d6ecd2ab5_58460671')) { function content_5cc56d6ecd2ab5_58460671($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cc56d6ecef0e0_60774061')) { function content_5cc56d6ecef0e0_60774061($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
