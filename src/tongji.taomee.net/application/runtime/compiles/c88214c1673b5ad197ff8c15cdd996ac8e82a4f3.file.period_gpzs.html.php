<?php /*%%TemplateHeaderCode:11033125715cb58950bb11c8-45025380%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    'c88214c1673b5ad197ff8c15cdd996ac8e82a4f3' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/gameanalysis/period_gpzs.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '11033125715cb58950bb11c8-45025380',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5cb58950d96a94_41732606',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cb58950d96a94_41732606')) { function content_5cb58950d96a94_41732606($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '11033125715cb58950bb11c8-45025380');
content_5cb58950c60b53_16427076($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '11033125715cb58950bb11c8-45025380');
content_5cb58950cb2f59_23029264($_tpl);
$_tpl = array_pop($_tplStack);
...
"></script>
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/common/heatmap.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>	
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
...
"></script>
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/gameanalysis/period_gpzs.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb58950c50ed5_46419513')) { function content_5cb58950c50ed5_46419513($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb58950c60b53_16427076')) { function content_5cb58950c60b53_16427076($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5cb58950cb2f59_23029264')) { function content_5cb58950cb2f59_23029264($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
