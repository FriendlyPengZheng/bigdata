<?php /*%%TemplateHeaderCode:12239750685c99c6f47892e4-40716757%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '81dda00f62eeffea701f07a5d3be1673a85abae2' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/conf/holidays.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '12239750685c99c6f47892e4-40716757',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5c99c6f4911be8_30258764',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c99c6f4911be8_30258764')) { function content_5c99c6f4911be8_30258764($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
<link rel="stylesheet" type="text/css" href="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/common/css/fullcalendar.css?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
">
<link rel="stylesheet" type="text/css" href="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/css/page/conf/conf.css?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
">
<link rel="stylesheet" type="text/css" href="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/css/page/conf/calendar.css?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
">
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav-blank.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '12239750685c99c6f47892e4-40716757');
content_5c99c6f4850d63_89244517($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '12239750685c99c6f47892e4-40716757');
content_5c99c6f4872eb8_59439678($_tpl);
$_tpl = array_pop($_tplStack);
/* End of included template "layout/aside.html" */?>
    <div class="content">
        <div class="calendar-wrapper clearfix">
            <div id="J_externalEvents" class="calendar-events">
                <div class="calendar-events-wrapper">
                    <h4>可添加的事件</h4>
                    <div class="fc-event">假期</div>
                </div>
            </div>
...
<script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/common/js/moment.min.js"></script>
<script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/common/js/fullcalendar.min.js"></script>
<script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/conf/holidays.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c99c6f4850d63_89244517')) { function content_5c99c6f4850d63_89244517($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c99c6f4872eb8_59439678')) { function content_5c99c6f4872eb8_59439678($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
