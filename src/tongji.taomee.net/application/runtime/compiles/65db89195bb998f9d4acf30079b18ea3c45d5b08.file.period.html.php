<?php /*%%TemplateHeaderCode:3919544435a952375234cd0-61648782%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '65db89195bb998f9d4acf30079b18ea3c45d5b08' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/public/period.html',
      1 => 1484553623,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '3919544435a952375234cd0-61648782',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5a95237568a440_35696356',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a95237568a440_35696356')) { function content_5a95237568a440_35696356($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '3919544435a952375234cd0-61648782');
content_5a952375411899_00607162($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav-blank.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '3919544435a952375234cd0-61648782');
content_5a9523754611b1_37124823($_tpl);
$_tpl = array_pop($_tplStack);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '3919544435a952375234cd0-61648782');
content_5a9523754add54_07008759($_tpl);
$_tpl = array_pop($_tplStack);
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a9523753e2b09_92117771')) { function content_5a9523753e2b09_92117771($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a952375411899_00607162')) { function content_5a952375411899_00607162($_tpl) {?><div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a9523754611b1_37124823')) { function content_5a9523754611b1_37124823($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
    <ul class="main-sub-nav">
        <?php if (isset($_tpl->tplVars['response']->value['admin_auth'])) {?>
        <li class="sub-nav-li posr stat-button" title="模板管理">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5a9523754add54_07008759')) { function content_5a9523754add54_07008759($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
