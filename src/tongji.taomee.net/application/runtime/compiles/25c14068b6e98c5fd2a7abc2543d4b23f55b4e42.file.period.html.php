<?php /*%%TemplateHeaderCode:13751894135c94d66d67e0c0-17586654%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '25c14068b6e98c5fd2a7abc2543d4b23f55b4e42' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/public/period.html',
      1 => 1534838549,
      2 => 'file',
    ),
    ...
    'a963d766d9aeb1aa1272971b02cdd01c5ea9b3b5' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/layout/sub-nav.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '13751894135c94d66d67e0c0-17586654',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5c94d66d88d2d0_68169111',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c94d66d88d2d0_68169111')) { function content_5c94d66d88d2d0_68169111($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '13751894135c94d66d67e0c0-17586654');
content_5c94d66d7553d8_63093133($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav-blank.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '13751894135c94d66d67e0c0-17586654');
content_5c94d66d77baf8_38243719($_tpl);
$_tpl = array_pop($_tplStack);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '13751894135c94d66d67e0c0-17586654');
content_5c94d66d7a3050_96155511($_tpl);
$_tpl = array_pop($_tplStack);
/* End of included template "layout/aside.html" */?>
    <input type="hidden" id="J_gGameId" value="<?php echo $_tpl->tplVars['response']->value['param']['game_id']; ?>
" />
    <input type="hidden" id="J_gGpzsId" value="<?php echo $_tpl->tplVars['response']->value['param']['gpzs_id']; ?>
" />
...
"></script>
    <script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/public/period.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c94d66d73e981_66984637')) { function content_5c94d66d73e981_66984637($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c94d66d7553d8_63093133')) { function content_5c94d66d7553d8_63093133($_tpl) {?><div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c94d66d77baf8_38243719')) { function content_5c94d66d77baf8_38243719($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
    <ul class="main-sub-nav">
        <?php if (isset($_tpl->tplVars['response']->value['admin_auth'])) {?>
        <li class="sub-nav-li posr stat-button" title="模板管理">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c94d66d7a3050_96155511')) { function content_5c94d66d7a3050_96155511($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
