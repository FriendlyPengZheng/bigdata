<?php /*%%TemplateHeaderCode:8384552025c99c796bbb888-89684313%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    'bdb6cf38a1d8f434fb09e070f3a237b95159ff8e' => 
    array (
      0 => '/opt/home/sevin/project/tongji.taomee.net/application/view/conf/online.html',
      1 => 1534838549,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '8384552025c99c796bbb888-89684313',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_5c99c796d05b12_48368864',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c99c796d05b12_48368864')) { function content_5c99c796d05b12_48368864($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/sub-nav-blank.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '8384552025c99c796bbb888-89684313');
content_5c99c796c59699_07678157($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("layout/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '8384552025c99c796bbb888-89684313');
content_5c99c796c75e47_08421875($_tpl);
$_tpl = array_pop($_tplStack);
...
?>
                <tr>
                    ...
                    <td class="td hd">
                        <a href="#" class="upd-btn btn-green" data-id="<?php echo $_tpl->tplVars['game']->value['game_id']; ?>
" data='<?php echo json_encode($_tpl->tplVars['game']->value); ?>
' title="修改数据配置">修改</a>
                    </td>
                </tr>
                <?php } ?>
...
<script src="<?php echo $_tpl->tplVars['response']->value['res_server']; ?>
/data/js/page/conf/online.js?v=<?php echo $_tpl->tplVars['response']->value['application_info']['version']; ?>
"></script>

    </body>
</html>
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c99c796c59699_07678157')) { function content_5c99c796c59699_07678157($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_5c99c796c75e47_08421875')) { function content_5c99c796c75e47_08421875($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
