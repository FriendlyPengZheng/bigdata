<?php /*%%TemplateHeaderCode:77143895359ed5eed619532-68944148%%*/ $_valid = $_tpl->decodeProperties(
array (
  'file_dependency' => 
  array (
    '82cdd575926acdb0d1cc1df6d539d7ad53012966' => 
    array (
      0 => '/var/www/tongji.taomee.net/application/view/gameanalysis/realtime.html',
      1 => 1484553623,
      2 => 'file',
    ),
  ...
  'no_cache_hash' => '77143895359ed5eed619532-68944148',
  'variables' => 
  array (
    'response' => 0,
    'd' => 0,
  ...
  'unifunc' => 'content_59ed5eedaedeb4_10775672',
),
false); /*/%%TemplateHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ed5eedaedeb4_10775672')) { function content_59ed5eedaedeb4_10775672($_tpl) {?><!DOCTYPE html>
<html>
    <head>
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/sub-nav.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '77143895359ed5eed619532-68944148');
content_59ed5eed7dc5e1_58719064($_tpl);
...
$_tplStack[] = $_tpl;
$_tpl = $_tpl->setupInlineSubTemplate("gameanalysis/aside.html", $_tpl->cacheId, $_tpl->compileId, 0, null, array(), 0, '77143895359ed5eed619532-68944148');
content_59ed5eed8b5e38_57483719($_tpl);
$_tpl = array_pop($_tplStack);
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_59ed5eed7b5273_90752351')) { function content_59ed5eed7b5273_90752351($_tpl) {?><!-- 不含任何二级nav -->
<div class="wrapper">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_59ed5eed7dc5e1_58719064')) { function content_59ed5eed7dc5e1_58719064($_tpl) {?><div class="wrapper">
    <ul class="main-sub-nav">
        <li class="sub-nav-li">
            <select id="J_game">
...
<?php }} ?>
<?php if ($_valid && !is_callable('content_59ed5eed8b5e38_57483719')) { function content_59ed5eed8b5e38_57483719($_tpl) {?><div class="aside" id="J_aside">
    <ul class="bt">
