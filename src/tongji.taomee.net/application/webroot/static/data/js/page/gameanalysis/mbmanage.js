...
$(function(){
    ...
    var options = {
        url: "index.php?r=gameanalysis/webgame/economy/importItem&ajax=1",
        dataType: "json",
...
function _showSetCategory(ids, more) {
    ...
    SETDIALOG = $.Dlg.Util.popup({
        ...
        save: function(con) {
            ...
            var url = getUrl("gameanalysis/mobilegame", "economy", "setItemCategory");
            url = more ? getUrl("gameanalysis/mobilegame", "economy", "setCategoryItem", "append=1") : url;
            ajaxData(url, {
...
function _getItemCategoryList(itemId) {
    ...
    ajaxData(getUrl("gameanalysis/mobilegame", "economy", "getItemCategory"), {
        item_id: itemId,
        sstid: "_coinsbuyitem_",
        game_id: $("#J_paramGameId").val()
    }, function(data){
