...
lang: {
    logining: lang.t("登录中"),
    login: lang.t("登录"),
    uid_no_empty: lang.t("用户名不能为空"),
    passwd_no_empty: lang.t("密码不能为空"),
    vericode_no_empty: lang.t("验证码不能为空"),
    vericode_less_code: lang.t("验证码长度错误"),
    vericode_error: lang.t("验证码错误")
},
isLogin: false,
dialog: null,
hint: null,
...
setLoginStatus: function(isDuringLogin) {
    if (isDuringLogin) {
        this.form.submitBtn.attr("loading", 1).val(this.lang.logining);
    } else {
        this.form.submitBtn.removeAttr("loading").val(this.lang.login);
    }
},
...
showError: function(msg) {
    ...
    var errorMsg = { errorSystem: lang.t("系统错误") };
