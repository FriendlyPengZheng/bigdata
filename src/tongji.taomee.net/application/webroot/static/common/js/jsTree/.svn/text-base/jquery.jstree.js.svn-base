	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' +
				...
				'.jstree li { display:block; min-height:18px; line-height:18px; font-size:12px; white-space:nowrap; margin-left:18px; min-width:18px; } ' +
...
(function ($) {
	$.jstree.plugin("cookies", {
		...
		_fn : {
            // add by violet 2013-8-6, 自定义记录的打开节点
            save_opened_cookie : function(save_opened) {
				if(this.data.core.refreshing) { return; }
				var s = this._get_settings().cookies;
                $.cookie(s.save_opened, save_opened.join(","), s.cookie_options);
            },
...
(function ($) {
	...
	$.vakata.dnd = {
		...
		drag_stop : function (e) {
			...
			$("body").css({'cursor' : 'default'}); //candice
			...
			if(s.drag_target) {
				$(document)
					.delegate(s.drag_target, "mousedown.jstree-" + this.get_index(), $.proxy(function (e) {
						o = e.target;
						$.vakata.dnd.drag_start(e, { jstree : true, obj : e.target }, "<ins class='jstree-icon'></ins>"
                            + $(e.target).text() );
						if(this.data.themes) {
	...
	$(function() {
		var css_string = '' +
			'#vakata-dragged ins { display:block; text-decoration:none; width:16px; height:16px; margin:0 0 0 0; padding:0; position:absolute; top:2px; left:2px; ' +
