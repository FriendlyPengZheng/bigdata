...
class backend_proto_forbidAlarmHeader extends TMProtoMessage
{
    public $protoId = null;
    ...
    public function hasFbdFlag()
    {
        return $this->has(3);
    }
    
    public function clearFbdFlag()
    {
        return $this->clear(3);
    }
    
    public function getFbdFlag()
    {
        return $this->get(3);
    }
    
    public function setFbdFlag($value)
    {
