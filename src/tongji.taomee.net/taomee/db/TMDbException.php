<?php
/**
 * TMDbException class file.
 */

/**
 * TMDbException represents an exception that is caused by some DB-related operations.
 */
class TMDbException extends TMException
{
    /**
    ...
    /**
     * Returns a TMDbException, reporting the query sql that throw an exception during preparing.
    ...
    /**
     * Returns a TMDbException, reporting the query sql and parameters that throw an exception during querying.
     * @param Exception $driverEx driver exception
     * @param string $sql the query sql
