(function($, undefined) {
	...
	ModuleManage("wrap", {
		...
		_createHeader: function() {
			...
			this.copy = this._createButton("mod-copy fr ml5").attr("title", o.copyTitle).appendTo(head);
			if(o.remove){
			...
			if(o.comment) {
				this.comment = this._createButton("mod-comment-btn fr ml5").attr("title", o.commentTitle).appendTo(head);
			}
