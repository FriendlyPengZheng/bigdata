...
function _mbEvent(option) {
    return $(document.createElement("a")).addClass("mod-mb btn-green mod-list-btn").attr({
        ...
        _newTrEvent($(this), function(container) {
            ...
            console.log("friendly--------------------comming in _getMbInCategoryConfig");
        });
    });
}
...
function _getChildConfig(container, id) {
    ...
    return [{
        ...
        container: container,
        isAjax: true,
        renameUrl: "../../../../common/economy/setCategory",
        pagination: true,
        url: {
            page: "getPageParam",
            paginationUrl: "../../../../common/economy/getCategorySaleListTotal?parent_id=" + id
                + "&sstid=" + (TABSTYPE == "coinsbuyitem" ? "_coinsbuyitem_" : "_mibiitem_"),
            extend: "../../../../common/economy/getCategorySaleList?parent_id=" + id
                +"&sstid=" + (TABSTYPE == "coinsbuyitem" ? "_coinsbuyitem_" : "_mibiitem_")
        },
        thead: [{
        ...
        appendColumns: [{
            ...
            type: "data", key: "buycount", isID : 0 }, {
            type: "data", key: "salenum", isID : 0 }, {
            type: "data", key: "salemoney", isID : 0 },
            "childTableEvent"]
    }];
}
...
function _getMbInCategoryConfig(container, id) {
    return [{
        ...
        url: {
            page: "getPageParam",
            paginationUrl: "../../../../common/economy/getItemSaleListTotal?parent_id=" + id
            + "&sstid=" + (TABSTYPE == "coinsbuyitem" ? "_coinsbuyitem_" : "_mibiitem_"),
            extend: "../../../../common/economy/getItemSaleList?category_id=" + id
            +"&sstid=" + (TABSTYPE == "coinsbuyitem" ? "_coinsbuyitem_" : "_mibiitem_")
        },
        thead: [{
    ...
    if(type == "category" && mbInCategory || type == "item") { //按道具|按类别-道具趋势
        return [{
            ...
            child: [{
                type: "data",
                url: {
                    extend: ["", "../../../../common/economy/getItemSaleDetail?sstid="
        ...
        return [{
            ...
            child: [{
                type: "data",
                url: {
                    extend: ["", "../../../../common/economy/getCategorySaleDetail?sstid=_coinsbuyitem_&factor=0.01"
                                + "&category_id=" + id],
                    page: function() {
                        return getPageParam();
                    }
