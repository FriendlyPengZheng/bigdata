...
function _createNaviSettings(con){
    ...
    // TODO getModules函数整合
    ajaxData("../navi/getModules?", null, function(data){
...
function _updModule(container, id) {
	...
	ajaxData("../component/getComponentById?", {
        componentId: id
    }, function(data){
    ...
    if (_checkForm()) {
        ...
        if (DIALOG.addModule.cur && DIALOG.addModule.curid) { //upd
            ...
            //ajaxData(getUrl("admin", "manage", "updateComponent"), param, function(data) {
                ajaxData("../component/updateComponent?",  
                //success => show
                { jsonString: JSON.stringify(param, true)},
                function(data) {
                _clear();
            ...
            //ajaxData(getUrl("admin/addComponent"), param, function(data) {
              ajaxData("../component/addComponents?" ,
                //success => show
                { 
            	  jsonString: JSON.stringify(param, true),
...
function getModuleList(id, fn){
    ...
    ajaxData("../component/getComponents?", {
        moduleKey: _getModuleKey(),
        parentId: id,
        gameId: _getGameId()
        /*gameId:0*/
        ...
        DIALOG.setComments = $.Dlg.Util.popup({
            ...
            save: function(con) {
                ...
                $("#J_itemCommentList").find(".item-li").each(function(){
                    ...
                    //console.log("comment_id" + JSON.stringify($(this), true));
                    //console.log("comment" + $(this).attr("comment"));
                });
                    //ajaxData(getUrl("admin", "manage", "saveComments"), {
                   ajaxData("../componentcomment/save?", {
    ...
    if(commentData) {
        ...
        $.choose.core(options);
          ...
          //ajaxData(getUrl("common", "comment", "getComments"), null, function(data){
    	   // ajaxData("../comment/getComments", null, function(data) {
    		console.log("ajax test");
    	    ajaxData("../../../../comment/getComments?",{
    	    //ajaxData("getComments?",{
    	    	"keyword" : "",
    	    	"commentId" : "",
    	    	"fetchType" : 3
    	    }, function(data) {
...
function _getItemCommentList(componentId) {
    ...
    //ajaxData(getUrl("admin", "manage", "getComments"), {
     // console.log(data);
      ajaxData("../../../../componentcomment/getComments?", {
...
function _bindNewCommentEvent() {
    $("#J_addCommentBtn").click(function() {
        ...
        if(param.keyword && param.comment) {
        	   ...
        	   ajaxData("../comment/save?", param, function(data) {
        		//console.log("data" + JSON.stringify(data, true));
               param.commentId = data.commentId;
               console.log("param.commentId" + param.commentId);
