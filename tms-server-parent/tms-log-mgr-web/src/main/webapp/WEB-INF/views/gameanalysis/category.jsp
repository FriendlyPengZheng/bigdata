	...
	<div class="main with-aside">
		...
		<div class="content" id="J_tableContainer">
			<div class="content-header clearfix">
				<a class="add-btn" id="J_addBtn">添加类别</a>
...
<%@ include file="./aside.jsp" %>
    <div class="content clearfix">
        ...
        <input type="hidden" id="J_paramPlatformId" value="${requestScope.platform_id}" />
...
<cc:overwrite name="pagejs">
	...
	<script
		src="<c:url value='/js/data/page/gameanalysis/category.js'/>?v=<%=System.currentTimeMillis()%>"></script>
	<script
		src="<c:url value='/js/data/page/gameanalysis/tm.form.js'/>?v=<%=System.currentTimeMillis()%>"></script>
</cc:overwrite>
