	...
	<div class="main with-aside">
		...
		<div class="content clearfix">
			...
			<div class="content-header clearfix" id="J_contentHeader">
				...
				<div class="datepicker-trigger radius5-all r mr5 single"
					id="J_from_to">
					<input type="hidden" id="J_from" value="${requestScope.fromDate}" />
					<i class="datepicker-icon"></i> <input class="title" type="text"
						id="J_date" value="${requestScope.fromMonth}" /> <i
...
<cc:overwrite name="pagejs">
	...
	<script
		src="<c:url value='/js/data/page/gameanalysis/month_gp.js'/>?v=<%=System.currentTimeMillis()%>"></script>
</cc:overwrite>
